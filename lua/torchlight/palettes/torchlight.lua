-- The original torchlight palette, mixed by hand.
--
-- Every palette module returns a flat table of the same keys. The group
-- modules take that table as an argument, so a variant needs no change to
-- them.
